...
1. Trước khi bắt đầu tải dữ liệu lên Google Engine: Tài khoản Google của bạn cần [giảm mức độ an toàn truy cập] (https://www.google.com/settings/security/lesssecureapps). 
