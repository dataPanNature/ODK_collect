...
- [Java](https://www.java.com/en/download) đã được cài đặt trên máy tính là phiên bản 7 hoặc cao hơn từ địa chỉ
...
sẽ mở ra giao diện như sau


Thiết lập ứng dụng Google Engine
Trước khi bắt đầu tải dữ liệu lên Google Engine: Tài khoản Google của bạn cần được thiết
lập theo các bước sau:
1. Mở giao diện web và truy cập đến địa chỉ:
https://www.google.com/settings/security/lesssecureapps
Đường link đến bảng điều khiển
Đường link URL
Tên dự án
Số ID của dự án74 | T r a n g
2. Trong hộp cần tích vào nhãn ghi “Access for less secure apps” hoặc cho phép ứng dụng
kém an toàn truy cập, tích vào mục “Turn on” hoặc bật lên


Cài đặt ODK Aggregate và thiết lập máy chủ
